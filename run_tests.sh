...
echo "Defector: <0,0,996>"
echo "Suspicious doormat: <1,0,1>"
echo "Actual result:"
...
echo "Expected result:"
echo "Suspicious TFT: <2,2,600>"
echo "Suspicious cooperator: <3,2,595>"
echo "Actual result:"
...
echo "Expected result:"
echo "Deceptive defector: <4,4,994>"
echo "Gullible doormat: <5,4,4>"
echo "Actual result:"
